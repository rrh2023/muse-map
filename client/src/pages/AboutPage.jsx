        ...
        <section className="about-section about-creator">
          <div className="about-creator-card">
            ...
            <p className="about-creator-bio">
              Muse Map was conceived and created by the Poet Laureate of Jersey City, Melida Rodas, an initiative to make the city's rich, diverse cultural life visible and
